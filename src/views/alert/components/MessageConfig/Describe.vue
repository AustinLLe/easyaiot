  ...
  <div class="describe-wapper">
    <Typography>
      <div v-if="noticeType == 'email'">
        ...
        <TypographyParagraph>
          1�?服务器地址<br />
          下拉可选择国内常用的邮箱服务配置，也支持手动输入其他地址�?          系统使用POP协议。POP允许电子邮件客户端下载服务器上的邮件，但是您在电子邮件客户端的操作（如：移动邮件、标记已读等），这时不会反馈到服务器上�?        </TypographyParagraph>
        <TypographyParagraph>
          2、发件人<br />
          用于发送邮件时“发件人“信息的显示
        </TypographyParagraph>
        <TypographyParagraph>
          3�?用户�?br />
          用该账号进行发送邮件�?        </TypographyParagraph>
        <TypographyParagraph>
          4、密�?br />
          用于账号身份认证，认证通过后可通过该账号进行发送邮件�?        </TypographyParagraph>
      </div>
      <div v-if="noticeType == 'sms'">
        ...
        <TypographyParagraph>
          ...
          获取路径：“阿里云管理控制台�?-“用户头像�?-“�?-“AccessKey管理�?-“查看�?        </TypographyParagraph>
      </div>
      ...
      <div v-if="noticeType == 'webhook'">
        ...
        <TypographyParagraph>
          ...
          POST请求），实现了Webhook的第三方系统可以基于该URL订阅本平台系统信息，本平台按配置把特定的事件结果推送到指定的地址，便于系统做后续处理�?        </TypographyParagraph>
        <TypographyTitle :level="5">2.通知配置说明</TypographyTitle>
        <TypographyParagraph>
          1、Webhook<br />
          Webhook地址�?br />
