...
function handleOk() {
  if (fileListRef.value.length > props.maxNumber)
    return createMessage.warning(t('component.upload.maxNumber', [props.maxNumber]))
...
<template>
  ...
  >
    <template #centerFooter>
      <a-button color="success" :disabled="!getIsSelectFile" :loading="isUploadingRef" @click="handleStartUpload">
        {{ getUploadBtnText }}
      </a-button>
    </template>
