...
import { usePreviewFitScale, usePreviewScrollYScale, usePreviewScrollXScale, usePreviewFullScale } from '@/hooks/design/index'
    ...
    addEventListener(
      ...
      (e: any) => {
        if (window?.$KeyboardActive?.ctrl) {
          ...
          const previewBoxDom = document.querySelector('.iot-preview') as HTMLElement
          const entityDom = document.querySelector('.iot-preview-entity') as HTMLElement
          if (previewBoxDom) {
